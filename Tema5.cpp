	...
	void mostrar_menu();
	void distribuir_atributos(char papel); //Enviando Informações. || Parâmetros
	...
	*/
	...
	//Break: Fim. Se não tiver Break ele irá passar descerá em todos os cases.
	//O Swtich trabalha com caracter inteiro.
	...
	case 'l':
		...
		vida = 10;
		break;
	//Default sempre é a última coisa a ser testado. Significa "Qualquer outra coisa".
	//Scope: Bloco.
default: 
