	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			for (int cont = 0; cont < 100; cont = cont 
			+10){
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// IF E ELSE OBDECEM AS CONDIÇOES DA VARIAVEL DO TIPO BOOLEANA, ONDE FOR SALVA VAI SER VERDADEIRO OU FALSO E ENTÃO O DESENHO SERÁ MOSTRADO NA TELA.
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
